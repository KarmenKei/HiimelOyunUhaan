...
### Attribution
```
"Photogrammetry Test Set: Skull - Cameramoves - Flash - No Background" by alansartlog / CC BY 4.0
```
...
```
["Photogrammetry Test Set: Skull - Cameramoves - Flash - No Background"](https://github.com/AlansCodeLog/photogrammetry-test-sets) by [alansartlog](https://alansartlog.com) / [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)
```